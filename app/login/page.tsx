...
export function LoginForm({
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
          ...
          <form className="p-6 md:p-8" onSubmit={handleSubmit}>
            <FieldGroup>
              ...
              <Field className="grid grid-cols-3 gap-4">
                <Button variant="outline" type="button" className="bg-muted hover:bg-muted/80">
      ...
      <FieldDescription className="px-6 text-center" style={{ color: "#374151" }}>
...
export default function LoginPage() {
  return (
    <div className="flex min-h-svh flex-col items-center justify-center p-6 md:p-10" style={{ backgroundColor: "#F7F7F7" }}>
